  ...
  try {
    ...
    if (includeHistory) {
      ...
      history = {
        ...
        recentFollowUps: followUps.slice(0, 5) as any // Type cast needed due to partial childFollowUps selection
      };
    }

    const response: FollowUpListResponse & { history?: ClientFollowUpHistory } = {
      success: true,
      data: followUps as any, // Type cast needed due to partial childFollowUps selection
      total,
      page,
      limit,
      history
