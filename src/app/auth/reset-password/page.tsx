...
export default function ResetPassword() {
  return (
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center bg-hud-background-secondary">
        <div className="animate-spin h-8 w-8 border-b-2 border-tactical-gold"></div>
      </div>
    }>
      <ResetPasswordForm />
    </Suspense>
