        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="px-4 py-2 text-sm bg-gold text-dark-grey hover:bg-gold-light font-space-grotesk font-bold uppercase tracking-wide"
            >
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        {activeTab === "insights" && (
          <div className="space-y-6">
            ...
            {/* Insights List */}
            <div className="space-y-4">
              <h3 className="font-medium text-gray-900">Generated Insights</h3>
              {insights.length === 0 ? (
            ...
            {!showScheduler ? (
              <div className="text-center py-8">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-gold text-dark-grey hover:bg-gold-light font-space-grotesk font-bold uppercase tracking-wide"
                >
                  Set Up Schedule
                </button>
                <div className="mt-4">
                  <button
                    ...
                    className="px-4 py-2 text-sm bg-blue-100 text-blue-700 hover:bg-blue-200 font-space-grotesk font-bold uppercase tracking-wide"
                  >
                    Advanced Scheduler
                  </button>
                </div>
